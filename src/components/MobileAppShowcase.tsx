          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-border p-3 text-center">
              ...
              <a href="https://app.cropxon.com" target="_blank" rel="noreferrer">
                <img src={qrImageUrl} alt="Cropxon Play Store QR" className="mx-auto mt-2 h-36 w-36 rounded-md border border-border" />
              </a>
            </div>
            <div className="rounded-lg border border-border p-3 text-center">
              <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">App Store</p>
              <a href="https://app.cropxon.com" target="_blank" rel="noreferrer">
                <img src={qrImageUrl} alt="Cropxon App Store QR" className="mx-auto mt-2 h-36 w-36 rounded-md border border-border" />
              </a>
            </div>
          </div>
        </div>
